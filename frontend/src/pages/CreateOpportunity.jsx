    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 w-full">
      ...
      >
        ...
        <h2 className="text-xl md:text-2xl font-bold text-center">
          ...
          <h2 className="text-center">Post a volunteer opportunity for waste management and recycling.</h2>
        {/* TITLE */}
        <div>
          <label className="label">Opportunity Title</label><br/>
          <input
            name="title"
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="label">Duration</label><br/>
            <input
              name="duration"
              onChange={handleChange}
              className="input border rounded-md border-gray-400 w-full"
        ...
        <button
          type="submit"
          className="w-full bg-blue-600 hover:bg-gray-200 hover:text-blue-700 transition text-white py-3 rounded-lg font-semibold shadow-md hover:shadow-lg cursor-pointer"
        >
          Submit Opportunity
        </button>
